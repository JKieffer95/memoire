...
Enfin, étant donné $E$, montrons que son stabilisateur est l'ensemble des idéaux principaux. Si $\frak a$ est principal, il laisse un relèvement $E^0$ invariant, et donc $E$ également. Réciproquement, si $\frak a$ laisse $E$ invariante, %on a un diagramme commutatif
%
%$$
%\shorthandoff{;:!?}
%\xymatrix @!=8mm {
...
%On pourrait bien sûr tenter de trouver une équation polynomiale reliant  par la force brute, mais
